...
export default function CollegeAdminDashboard({ user }) {
  ...
  const collegeCategory = (detectCollegeCategory(user)).trim();
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 text-gray-800 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between gap-4 mb-6">
          <div>
            <h1 className="text-2xl md:text-3xl font-semibold text-gray-900">{detectCollegeCategory(user)} Department Admin</h1>
        ...
        <footer className="mt-8 text-center text-sm text-gray-500">
          © {new Date().getFullYear()} Smart Complaint Register — College Admin
        </footer>
      </div>
    </div>
  );
